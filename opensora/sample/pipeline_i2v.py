...
@dataclass
class Image2VideoOutput(BaseOutput):
    video: torch.Tensor


class Image2VideoPipeline(DiffusionPipeline):
    r"""
    ...
    def __call__(
        ...
        if not output_type == 'latents':
            ...
            video = latents
            return Image2VideoOutput(video=video)
