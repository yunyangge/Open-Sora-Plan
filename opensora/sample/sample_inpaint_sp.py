...
def run_model_and_save_images(pipeline, model_path):
    ...
    def preprocess_pixel_values(pixel_values_path, frame_interval=1, min_clear_ratio=0.125):
        ...
        elif isinstance(pixel_values_path, list) and is_video_file(pixel_values_path[0]):
