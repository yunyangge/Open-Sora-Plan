...
logger = get_logger('dataset.transition')
...
class Transition_dataset(T2V_dataset):
    def __init__(self, args, resize_transform, transform, resize_transform_img, temporal_sample, tokenizer_1, tokenizer_2):
        ...
        if self.num_frames != 1:
            ...
            logger.debug(f"t2v_ratio={args.t2v_ratio}, i2v_ratio={args.i2v_ratio}, transition_ratio={args.transition_ratio}, v2v_ratio={args.v2v_ratio}, clear_video_ratio={args.clear_video_ratio}")
            
            self.mask_type_ratio_dict_video = {
                MaskType.t2iv: 0., 
                MaskType.i2v: 0., 
                MaskType.transition: 1., 
                MaskType.v2v: 0., 
                MaskType.clear: 0., 
