...
def getdataset(args):
    ...
    if torch_npu is not None:
        ...
        tokenizer_1 = AutoTokenizer.from_pretrained('/storage/ongoing/new/Open-Sora-Plan/cache_dir/t5-v1_1-xl', cache_dir=args.cache_dir)
    tokenizer_2 = None
...
if __name__ == "__main__":
    ...
    args = type('args', (), 
    {
        ...
        'cache_dir': '../cache_dir', 
        'data': '/home/save_dir/projects/gyy/suv/Open-Sora-Plan/scripts/train_data/current_hq_on_npu_dit.txt', 
        'train_fps': 18, 
