...
from .opensora_v1_3.modeling_transition import OpenSoraTransition_models

Diffusion_models = {}
Diffusion_models.update(OpenSora_v1_3_models)
Diffusion_models.update(OpenSoraInpaint_v1_3_models)
Diffusion_models.update(OpenSoraTransition_models)
...
from .opensora_v1_3.modeling_transition import OpenSoraTransition_models_class
...
Diffusion_models_class.update(OpenSoraTransition_models_class)
