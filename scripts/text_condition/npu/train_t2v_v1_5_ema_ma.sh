...
accelerate launch \
    ...
    --num_frames 1 \
    --force_ratio \
    --max_h_div_w_ratio=0.75 \
    --min_h_div_w_ratio=0.4 \
    --max_hxw 331776 \
    --min_hxw 147456 \
    ...
    --ema_update_freq 10 \
    --ema_decay 0.999 \
    --pretrained="/home/ma-user/work/checkpoint/gyy/runs/t2v_suv_from_dit_288x512_384x384_32x8x16_lr1e-4_wd1e-5_eps1e-15_total_recap/checkpoint-52500/model_ema"
    # --enable_tiling \
    # --resume_from_checkpoint="latest" \
    # --max_hxw 65536 \
    # --min_hxw 36864 \
